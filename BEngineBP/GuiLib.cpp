...
XMFLOAT2 BEngine::GuiLib::WorldToScreen(const XMFLOAT3& worldPoint, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, float screenWidth, float screenHeight)
{
